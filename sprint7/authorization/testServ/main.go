...
var (
	...
	rolePermissions = map[string][]string{
		AdminRole: []string{ReadPermission, WritePermission},
		UserRole:  []string{ReadPermission},
	}
)
...
var (
	...
	userRoles = map[string][]string{
		"Alice2000": []string{UserRole},
		"Mike123":   []string{AdminRole},
	}
)
...
// если пользователь ввел правильные данные,
// и у него есть необходимая привилегия — возвращаем true, иначе — false
